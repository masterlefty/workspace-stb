...
cpdefine("inline:com-chilipeppr-workspace-stb", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-stb", // Make the id the same as the cpdefine id
        name: "Workspace / Masterlefty/TinyG", // The descriptive name of your widget.
        desc: `This is the Masterlefty/TinyG workspace for ChiliPeppr.`,
